...
if (isset($_POST['add_product'])) {
    ...
    if(false){
        ...
        $insert_product = mysqli_query($conn, "INSERT INTO `products` (`name`) VALUES ('$product_name')") or die("Query failed");
...
<section class="show-products">
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="admin_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete" onclick="return confirm('want to delete?');">Delete</a>
        ...
        <?php 
            if(isset($_GET['edit'])){
                ...
                <form  method="post" enctype = "multipart/form-data">
                    ...
                    <!-- <input> -->
                    <!-- <button type="reset" name="" value="cancle" class="option-btn btn" id="close-form">Cancle</button> -->
                    <button type="reset" name="" value="cancle" class="option-btn btn" id="close-form" 
                    onclick="document.querySelector('.update-container').style.display = 'none';">Cancel</button>
                </form>
